<template>
  <main class="min-h-screen bg-base-200">
    ...
    <div 
      class="collapse collapse-arrow bg-base-100 lg:hidden sticky top-0 z-10 shadow-lg"
      :class="isTableOfContentsOpened ? 'collapse-open' : 'collapse-close'"
    >
      <input 
        type="checkbox" 
        class="min-h-0" 
        v-model="isTableOfContentsOpened"
      />
      ...
      <div class="collapse-content">
        <scrollspy
          @click="isTableOfContentsOpened = false"
          :sections="sectionsRef"
          scrollspy-list="menu space-y-1" 
          scrollspy-item="text-sm hover:bg-base-200 rounded-lg transition-colors"
        />
      </div>
    </div>
    ...
    <div v-else class="container mx-auto px-4 py-8 lg:py-12">
      <div class="flex gap-8">
        ...
        <div class="grid grid-cols-1 space-y-8">
              ...
              <div class="space-y-4">
                ...
                <div class="flex flex-wrap gap-4 text-sm text-base-content/70">
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    <time :datetime="selectedChemicalStore.getFirstPublicationDate().toISOString()" class="font-semibold">
            ...
            <section data-aos="fade-up" class="card bg-base-100 shadow-xl" id="2d_depiction">
              <div class="card-body">
                ...
                <div class="flex flex-wrap gap-2 mb-4">
                  ...
                  <NuxtLink 
                    :to="selectedChemicalStore.selectedChemical.chem_depiction_image" 
                    target="_blank" 
          ...
          <section data-aos="fade-up" class="card bg-base-100 shadow-xl" id="reference">
            <div class="card-body">
              ...
              <div class="space-y-3">
                <a 
                  v-for="citation in selectedChemicalStore.selectedChemical.literature" 
                  :key="citation.api_id"
                  :href="doiRedirectionSiteHost + citation.doi" 
                  target="_blank" 
                  rel="noopener noreferrer"
                ...
                >
                  ...
                  <time 
                    :datetime="selectedChemicalStore.getFirstPublicationDate().toISOString()" 
        ...
        <aside class="hidden lg:block w-64 flex-shrink-0">
          <div class="sticky top-4 card bg-base-100 shadow-xl">
            <div class="card-body p-4">
              <h3 class="font-bold text-lg mb-2">Table of Contents</h3>
              <scrollspy 
                :sections="sectionsRef" 
                scrollspy-list="menu menu-sm space-y-1" 
                scrollspy-item="text-sm hover:bg-base-200 rounded-lg transition-colors"
              />
            </div>
          </div>
