<template>
  <main class="min-h-screen bg-base-200">
        ...
        <div class="max-w-4xl mx-auto text-center mb-8">
          <div class="breadcrumbs text-sm mb-4">
            <ul>
              ...
              <li class="font-semibold">Chemicals</li>
            </ul>
          </div>
    ...
    <div class="container mx-auto px-4 py-8 space-y-6">
        ...
        <div class="card-body p-4 md:p-6">
          <div class="flex flex-col lg:flex-row items-center justify-between gap-4">
            ...
            <div class="text-sm text-base-content/70 order-2 lg:order-1">
              ...
              to
              <span class="font-semibold">{{ Math.min(pagination.state.pageSize * pagination.state.page,
                pagination.state.totalItems) }}</span>
              of
        ...
        <div class="card-body p-4 md:p-6">
          ...
          <div class="hidden md:flex items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-2">
              <button type="button" class="btn btn-outline btn-primary gap-2" @click="openFilterModal">
          ...
          <div class="flex md:hidden flex-col gap-3">
            ...
            <!-- Actions Row -->
            <div class="flex items-center gap-2">
              <button type="button" class="btn btn-sm btn-outline btn-primary gap-2 flex-shrink-0"
      ...
      <!-- Results Grid -->
      <div v-else-if="fetchChemicalStore.chemicals.length > 0"
        class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        <ChemicalCard v-for="chemical in fetchChemicalStore.chemicals" :key="chemical.api_id" :chemical="chemical"
      ...
      <!-- Empty State -->
      <div v-else-if="!fetchChemicalStore.loading && fetchChemicalStore.chemicals.length === 0"
        class="card bg-base-100 shadow-lg">
        <div class="card-body items-center text-center py-16">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            stroke="currentColor" class="w-24 h-24 text-base-content/30 mb-4">
            <path stroke-linecap="round" stroke-linejoin="round"
