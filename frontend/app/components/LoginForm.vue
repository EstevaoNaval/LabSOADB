    ...
    <main>
        <form @submit.prevent="handleLogin" autocomplete="on" class="space-y-6">
            ...
            <div class="form-control">
                ...
                <input id="email" v-model="email" type="email" name="email" placeholder="exemplo@gmail.com"
                    autocomplete="email" class="input  w-full focus:input-primary"
                    :class="{ 'input-error': authStore.error?.email }" required>
            ...
            <div class="form-control">
                ...
                <div class="relative">
                    <input id="password" v-model="password" :type="showPassword ? 'text' : 'password'" name="password"
                        ...
                        class="input  w-full pr-12 focus:input-primary"
                        :class="{ 'input-error': authStore.error?.password }" required>
                    <button type="button"
            ...
            <div class="text-right -mt-2">
                <NuxtLink to="/auth/password/forgot-password"
            ...
            <div class="form-control pt-2">
                <button type="submit" class="btn btn-primary btn-lg w-full gap-2" :disabled="isLoading"
        ...
        <div class="text-center space-y-4">
            ...
            <NuxtLink to="/auth/register" class="btn btn-outline btn-primary btn-lg w-full gap-2">
