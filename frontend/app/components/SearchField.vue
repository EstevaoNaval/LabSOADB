      ...
      <div role="tablist" class="tabs tabs-bordered mx-auto tabs-lg w-full">
        ...
        <div role="tabpanel" class="border-t-2 border-t-gray-100 border-opacity-30 tab-content p-10">
          <div class="join w-full">
            ...
            <div class="indicator">
              <button type="submit" class="btn btn-primary btn-outline h-full join-item" @click="handleSearchByRepresentation">
        ...
        <div role="tabpanel" class="border-t-2 border-t-gray-100 border-opacity-30 tab-content p-10">
            <div class="join w-full">
              ...
              <div class="indicator">
                <button type="submit" class="btn btn-primary btn-outline h-full join-item" @click="handleSearchByCitation">
