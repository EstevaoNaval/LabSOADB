        ...
        <form @submit.prevent="handleUserRegistration" class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="form-control">
                    ...
                    <input 
                        ...
                        :class="{ 'input-error': userStore.error?.first_name }"
                        required
                    >
                ...
                <div class="form-control">
                    ...
                    <input 
                        ...
                        placeholder="Snow"
                        class="input input-bordered w-full focus:input-primary"
                        :class="{ 'input-error': userStore.error?.last_name }"
                        required
                    >
            ...
            <div class="form-control">
                <label for="username" class="label justify-start px-0">
                    ...
                    <span class="label-text-alt ml-auto">
                        <div class="tooltip tooltip-left" data-tip="Only letters, numbers, hyphens, and underscores allowed">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-4 h-4 opacity-70 hover:opacity-100 transition-opacity cursor-help" viewBox="0 0 16 16">
                ...
                <input 
                    ...
                    class="input input-bordered w-full focus:input-primary"
                    :class="{ 'input-error': userStore.error?.username || usernameError }"
                    required
                >
            ...
            <div class="form-control">
                ...
                <input 
                    ...
                    autocomplete="email"
                    class="input input-bordered w-full focus:input-primary"
                    :class="{ 'input-error': userStore.error?.email }"
                    required
                >
            ...
            <div class="form-control">
                ...
                <div v-if="password && password.length > 0" class="mt-2">
                    <div class="flex gap-1 mb-1">
                        <div class="h-1 flex-1 rounded-full transition-all" :class="passwordStrength === 'weak' || passwordStrength === 'medium' || passwordStrength === 'strong' ? 'bg-error' : 'bg-base-300'"></div>
                        <div class="h-1 flex-1 rounded-full transition-all" :class="passwordStrength === 'medium' || passwordStrength === 'strong' ? 'bg-warning' : 'bg-base-300'"></div>
                        <div class="h-1 flex-1 rounded-full transition-all" :class="passwordStrength === 'strong' ? 'bg-success' : 'bg-base-300'"></div>
                    </div>
                ...
                <label v-if="userStore.error?.password1" class="label px-0">
                    <span class="label-text-alt text-error">
                        {{ Array.isArray(userStore.error.password1) ? userStore.error.password1[0] : userStore.error.password1 }}
                    </span>
                </label>
            </div>
            ...
            <div class="form-control">
                ...
                <label v-else-if="password_confirmation && password === password_confirmation && password.length >= passwordMinLength" class="label px-0">
                ...
                <label v-else-if="userStore.error?.password2" class="label px-0">
                    <span class="label-text-alt text-error">
                        {{ Array.isArray(userStore.error.password2) ? userStore.error.password2[0] : userStore.error.password2 }}
                    </span>
                </label>
            </div>
