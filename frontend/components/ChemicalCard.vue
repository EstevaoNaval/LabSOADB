        ...
        <div class="card bg-base-300">
            ...
            <div class="card-body">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="flex flex-col mx-auto" v-if="props.chemical.physical_property.molecular_weight">
                    ...
                    <div class="flex flex-col mx-auto" v-if="props.chemical.identifier.chem_formula">
                        ...
                        <p class="mx-auto font-bold" v-html="utils.replaceStringNumberBySubscript(props.chemical.identifier.chem_formula)"></p>
                    </div>
